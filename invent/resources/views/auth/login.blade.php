...
<div
    class="login_page min-w-screen min-h-screen bg-gradient-to-b from-blue-100 to-white flex flex-col items-center justify-center lg:flex-row p-4">
    ...
    <div class="login_card rounded-2xl bg-white items-center p-5 m-2 border border-[#64748B] w-full max-w-md lg:ml-10">
        ...
        <div class="login_form  ">
            <form method="POST" class="flex flex-col gap-3 mt-5" action="{{ route('login') }}">
                ...
                <input class="border-0 border-b-2 border-gray-400 focus:outline-none" name="email" type="email"
                    value="{{ old('email') }}" placeholder='Enter your email or username' />
                    
                    <label htmlFor="password">Password</label>
                    <input class="border-0 border-b-2 border-gray-400 focus:outline-none" name="password" type="password"
                    ...
                    <button class="!bg-[#2563EB] text-white py-2 rounded-md hover:bg-blue-700 transition"
